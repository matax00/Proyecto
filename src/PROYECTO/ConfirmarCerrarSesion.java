 ...
 * @author FerSo
 */
public class ConfirmarCerrarSesion extends javax.swing.JFrame {
   ...
   public Image getIconImage() {
    ...
    private void initComponents() {
        ...
        lblTituloSalir.setText("¿Cerrar Sesion?");
        jPanel1.add(lblTituloSalir);
        lblTituloSalir.setBounds(10, 30, 250, 50);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConfirmarCerrarSesion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run(){            new ConfirmarCerrarSesion().setVisible(true);
            }
        });
                }
